#unlike the last version this one doesn't use weird concatenation.
import random
import time
bot_choice=""
human_choice=""
stop_yes_no=""
continue_or_first="first"
print("Welcome to the rock paper scissors game!")
while stop_yes_no!=2:
    if continue_or_first=="first":
        stop_yes_no=int(input("Do you want to play? type 1 if yes and 2 if no. "))
    if continue_or_first=="continue":
        stop_yes_no=int(input("Do you want to continue playing? type 1 if yes and 2 if no. "))
    if stop_yes_no==2:
        break
